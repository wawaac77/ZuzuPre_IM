...
- (void)setupNavigation {
    ...
    //self.title = @"Chat";
    self.title = ZBLocalized(@"Inbox", nil);
    
    _titleLabel.text = ZBLocalized(@"Inbox", nil);
    ...
    [_rightBarButton setImage:[UIImage imageNamed:@"ic_new-message"] forState:UIControlStateNormal];
